...
public class AddOffre extends javax.swing.JFrame {
    ...
    public AddOffre(JTable table) {
        ...
        lbl_image.setIcon(new ImageIcon("..\\offre.jpg"));
    ...
    private void initComponents() {
        ...
        lbl_image.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/Icon/offre.jpg"))); // NOI18N
    ...
    private void btn_v_ajout_offreActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btn_v_ajout_offreActionPerformed
        ...
        OffreDAO.upateTableOffre(table);
        this.dispose();
